...
public class LuceneRun {
    ...
    public static void main(String[] args) throws IOException {
        ...
        s = "";
        PrintWriter writer = new PrintWriter("LuceneRun.txt", "UTF-8");
            try {
            	String cwd = System.getProperty("user.dir");
            	File query_file = new File(cwd + "\\src\\cleaned_query.txt");
            	BufferedReader file_br = new BufferedReader(new FileReader(query_file));
            	String str;
